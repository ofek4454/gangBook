...
class HistoryScreen extends StatelessWidget {
  ...
  int userArriveTo(BuildContext context, List<Meet> meets) {
    final uid = Provider.of<CurrentUser>(context, listen: false).user.uid;
    int retVal = 0;

    for (Meet meet in meets) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<Meet>>(
        future: AppDB().getMeetsHistory(currentGang.gang.id),
